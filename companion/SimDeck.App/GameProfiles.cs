...
public static class GameProfiles
{
    ...
    public static string Help(GameProfile profile) => profile.Id switch
    {
        ...
        "acc" => "ACC: Shared Memory подключается автоматически после выхода на трассу. На пульте доступны приборы, четыре шины и тормоза; клавиши управления назначьте в Controls.",
